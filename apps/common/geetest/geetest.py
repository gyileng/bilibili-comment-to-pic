...
# 请在官网申请ID使用，示例ID不可使用
pc_geetest_id = "82b04fdc5978151306da071da5dd1b2c"
pc_geetest_key = "44dad66261165a69c2a032417167df05"
...
class GeetestLib(object):
    ...
    def __init__(self):
        self.private_key = pc_geetest_key
        self.captcha_id = pc_geetest_id
        self.sdk_version = VERSION
        self._response_str = dict()
